...
from clinical_nlp.extractors import (
    HybridExtractor,
    LLMExtractor,
    NLPExtractor,
    TriagePolicy,
    compress_note_for_llm,
    remap_mentions_to_source,
)
...
def test_conditional_mention_is_hypothetical() -> None:
    result = resolve("If chest pain recurs, return to ED.", "chest pain", EntityType.SYMPTOM)
...
def test_smothered_does_not_trigger_family_history() -> None:
    ...
    result = resolve("The fire was smothered; patient reports anxiety.", "anxiety", EntityType.SYMPTOM)
